...
def update_book(id, title=None, authors=None, average_rating=None, isbn=None, 
                isbn13=None, language_code=None, num_pages=None, ratings_count=None, 
                text_reviews_count=None, publication_date=None, publisher=None):
    suffix = f"/book/{id}"
    endpoint = BOOKS_API_URL + suffix
    ...
    if not payload:
        print("Error: At least one field must be provided for updating the book.")
        return
...
def main():
    ...
    parser.add_argument("-r", "--rating",
            help="Search parameter to look for books with average rating equal or above the param (0 to 5)", type=float, default=None)
    parser.add_argument("-p", "--pages",
            help="Search parameter to look for books with exact number of pages", 
            type=int, default=None)
    parser.add_argument("-t", "--title",
            help="Search parameter to look for books with matching title (partial match)", 
            default=None)
    ...
    parser.add_argument("-a","--authors", nargs="+", 
                        help="List of authors (e.g., --authors 'Julie Sylvester' 'David Sylvester')",
                        default=None)
    ...
    parser.add_argument("--ratings_count", type=int, help="Number of ratings", default=None)
    parser.add_argument("--reviews_count", type=int, help="Number of text reviews", default=None)
    ...
    if args.action == "search":
        ...
        update_book(
            args.id, args.title, args.authors, args.rating, args.isbn, args.isbn13, 
            args.language, args.pages, args.ratings_count, args.reviews_count, 
            args.pub_date, args.publisher
        )
